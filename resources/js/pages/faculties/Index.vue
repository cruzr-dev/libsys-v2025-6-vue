...
const handleEdit = (id) => {
    router.get(route('faculties.edit', id));
}
</script>
                    ...
                    <div class="flex gap-2">
                        <Link :href="route('faculties.create')">
                            <Button variant="secondary">
                                <Plus class="w-4 h-4" /> Add Faculty
                            </Button>
                        </Link>
                        <DropdownMenuRoot>
            ...
            <Dialog v-model:open="isDialogOpen">
                <DialogContent class="sm:max-w-4xl max-h-[95dvh] p-0 bg-background rounded-lg shadow-xl overflow-x-auto">
                    ...
                    <DialogHeader class="px-4 pt-4 pb-4 border-b">
                        <DialogTitle class="text-xl font-semibold text-foreground">Faculty Profile</DialogTitle>
                    </DialogHeader>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 py-0 overflow-y-auto">
                        ...
                        <div class="md:col-span-2 space-y-4">
                            ...
                            <div v-else class="text-muted-foreground p-4 text-center">
                                <p class="text-sm">No faculty selected.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <DialogFooter class="p-6 border-t bg-background">
                        <div class="flex justify-between w-full">
                            ...
                            <Button @click="handleEdit(selectedUser.id)" class="px-6">Edit Faculty Details</Button>
                        </div>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
