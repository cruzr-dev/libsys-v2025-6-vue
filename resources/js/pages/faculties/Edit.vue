...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Edit Faculty', href: `/users/students/${props.faculty.id}/edit` },
];
...
const submit = () => {
    ...
    router.post(route('faculties.update', props.faculty.id), formData, {
        headers: {
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <Layout>
            <div class="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl bg-white p-6 shadow-sm relative">
                ...
                <h2 class="text-xl text-center font-semibold text-gray-900">Edit Faculty Details</h2>
