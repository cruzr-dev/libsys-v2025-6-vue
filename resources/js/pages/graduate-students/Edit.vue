...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Edit Graduate Student', href: `/users/students/${props.student.id}/edit` },
];
...
const deleteStudent = (id: number | null) => {
    ...
    router.delete(route('graduate.destroy', id))
}
...
const submit = () => {
    ...
    router.post(route('graduate.update', props.student.id), formData, {
        headers: {
...
<template>
    <Head title="Edit Graduate Student" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <Layout>
            <div class="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl bg-white p-6 shadow-sm relative">

                <h2 class="text-xl text-center font-semibold text-gray-900">Edit Graduate Student Details</h2>
