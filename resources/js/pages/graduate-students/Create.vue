...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Students', href: '/users/graduate' },
    { title: 'Add Graduate Student', href: '/users/graduate/create' },
];
...
const submit = () => {
    form.post(route('graduate.store'));
};
...
<template>
    <Head title="Add Graduate Student" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <Layout>
            <div class="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl bg-white p-6 shadow-sm relative">

                <h2 class="text-xl text-center font-semibold text-gray-900">Add Graduate Student</h2>
